...
matched seeds; defaults marked $\star$). \emph{Placeholder numbers pending the
queued ablation suite; the mutation-rate rows are from an earlier matched run.}}
\label{tab:mut}
\footnotesize
\setlength{\tabcolsep}{3pt}
\begin{tabular}{@{}llccc@{}}
...
\multirow{3}{*}{mutation rate}
 & fixed $1\%$ & 0.686 & 0.280 & 0.339 \\
 & fixed $15\%$ & 0.774 & 0.369 & 0.336 \\
 & self-tuned $\star$ & 0.756 & 0.374 & 0.336 \\
\midrule
\multirow{3}{*}{spectral bias}
 & $\beta{=}0$ (white) & TBD & TBD & TBD \\
 & $\beta{=}1$ $\star$ & TBD & TBD & TBD \\
 & $\beta{=}2$ & TBD & TBD & TBD \\
\midrule
\multirow{2}{*}{crossover}
 & off & TBD & TBD & TBD \\
 & set-level $\star$ & TBD & TBD & TBD \\
\midrule
\multirow{2}{*}{$\chi_d$ repair}
 & off & TBD & TBD & TBD \\
 & every op.\ $\star$ & TBD & TBD & TBD \\
\midrule
\multirow{2}{*}{initialization}
 & white $\star$ & TBD & TBD & TBD \\
 & pink $\alpha{=}0.2$ & TBD & TBD & TBD \\
\bottomrule
\end{tabular}
\end{table}
