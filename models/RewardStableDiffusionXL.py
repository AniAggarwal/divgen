...
class RewardStableDiffusionXL(StableDiffusionXLPipeline):
    ...
    def decode_latents_tensors(self, latents):
        ...
        # Clear cache after VAE decode to free memory
        # Note: VAE is frozen, so intermediate activations can be cleared
        del scaled_latents
    ...
    def apply(
        ...
        for i, t in enumerate(timesteps):
            ...
            # Delete intermediate tensors from this iteration
        ...
        del prompt_embeds, add_text_embeds, add_time_ids
