...
class BaseRewardLoss(ABC):
    ...
    def __init__(self, name: str, weighting: float):
        ...
        self._text_feature_cache = {}  # Cache for text features by prompt
